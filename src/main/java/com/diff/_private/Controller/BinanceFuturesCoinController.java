...
@RestController
@RequestMapping("/BinanceFutures")
public class BinanceFuturesCoinController {
	...
	public List<HashMap<String, String>> CoinInfo(HttpServletRequest req) throws Exception {
		return BinanceFuturesCoinService.CoinInfo();
	}
	...
	public List<HashMap<String, String>> MainGridList(HttpServletRequest req) throws Exception {
		...
		return BinanceFuturesCoinService.MainGridList(map);
	}
	...
	public void CoinAnalysisCreate(HttpServletRequest req) throws Exception {
	    ...
	    String MainRankingCount = SettingMap.get("binance_report_main_ranking");
	    String SubRankingCount = SettingMap.get("binance_report_sub_ranking");
	    ...
	    map.put("blog_id", "5");
	    BinanceFuturesCoinService.TiStoryReportHTMLCreate(map);
	...
	public List<HashMap<String, String>> CoinDailyReportList(HttpServletRequest req) throws Exception {
		...
		map.put("std_date", std_date);
		map.put("end_date", end_date);
		return BinanceFuturesCoinService.CoinDailyReportList(map);
	}
	...
	public List<HashMap<String, String>> MainLiveRankList(HttpServletRequest req) throws Exception {
		...
		return BinanceFuturesCoinService.MainLiveRankList(map);
	}
	...
	public void ExcelMake_Daily(HttpServletRequest req, HttpServletResponse response) throws Exception {
		...
		try {
	        ...
	        List<HashMap<String, String>> result_map = BinanceFuturesCoinService.ExcelMake_Daily_Result(map);
	        ...
	        List<HashMap<String, String>> ranking_list = BinanceFuturesCoinService.ExcelMake_Daily_Ranking(map);
	        ...
	        HashMap<String, String> excel_map = BinanceFuturesCoinService.ExcelMake_Daily(map);
	        ...
	        form_sheet.getRow(Sheet1_Row).getCell(1).setCellValue("바이낸스 선물 일일 분석 " + date);
	        ...
	        summary_sheet.getRow(Sheet2_Row).getCell(1).setCellValue("바이낸스 선물 " + kor_date + " 코인 분석");
	        
	        row = summary_sheet.createRow(Sheet2_Row+1);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+1).getCell(1).setCellValue("바이낸스 선물 " + kor_date + " 코인 분석을 시작하겠습니다.");
	        
	        row = summary_sheet.createRow(Sheet2_Row+3);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+3).getCell(1).setCellValue("BTC 기준 시가 대비 종가 " + excel_map.get("summary_1_1") + kor_date+ " 바이낸스 선물 원화 코인 "+coin_total_count+"종 중 상승인 코인이 "+coin_increase_count+"종, 하락인 코인이 "+coin_degradation_count+"종, 보합인 코인이 "+coin_flat_count+"종입니다.");
	        ...
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+20).getCell(1).setCellValue(short_kor_date+" 바이낸스 선물 코인 요약");
	        
	        row = summary_sheet.createRow(Sheet2_Row+21);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+21).getCell(1).setCellValue(kor_date + " 바이낸스 선물 코인 중 BTC가 " + excel_map.get("summary_1_1") + " 바이낸스 선물 원화 코인 "+coin_total_count+"종 중 상승인 코인이 "+coin_increase_count+"종, 하락인 코인이 "+coin_degradation_count+"종, 보합인 코인이 "+coin_flat_count+"종입니다.");
	        ...
	        fileName = "바이낸스_선물_Daily_"+date+".xlsx";
	...
	public void ExcelMake_Weekly(HttpServletRequest req, HttpServletResponse response) throws Exception {
		...
		try {
	        ...
	        List<HashMap<String, String>> result_map = BinanceFuturesCoinService.ExcelMake_Weekly_Result(map);
	        String coin_total_count = result_map.get(0).get("total_count");
	        String coin_increase_count = result_map.get(0).get("increase_count");
	        String coin_degradation_count = result_map.get(0).get("degradation_count");
	        String coin_flat_count = result_map.get(0).get("flat_count");
	        ...
	        List<HashMap<String, String>> ranking_list = BinanceFuturesCoinService.ExcelMake_Weekly_Ranking(map);
	        
	        String result_data = " "+coin_total_count+" | " + coin_increase_count +" | " + coin_degradation_count +" | " + coin_flat_count;
	        form_wb.setSheetName(0, result_data);
	        
	        HashMap<String, String> excel_map = BinanceFuturesCoinService.ExcelMake_Weekly(map);
	        ...
	        form_sheet.getRow(Sheet1_Row).getCell(1).setCellValue("바이낸스 선물 주간 분석 " + std_date + " ~ " + end_date);
	        form_sheet.getRow(Sheet1_Row+3).getCell(2).setCellValue(coin_increase_count);
	        form_sheet.getRow(Sheet1_Row+3).getCell(3).setCellValue(coin_increase_ticker);
	        form_sheet.getRow(Sheet1_Row+5).getCell(2).setCellValue(coin_flat_count);
	        form_sheet.getRow(Sheet1_Row+5).getCell(3).setCellValue(coin_flat_ticker);
	        ...
	        Row row = summary_sheet.createRow(Sheet2_Row);
	        Cell cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row).getCell(1).setCellValue("바이낸스 선물 " + kor_jucha_date + " 코인 분석");
	        
	        row = summary_sheet.createRow(Sheet2_Row+1);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+1).getCell(1).setCellValue("바이낸스 선물 " + kor_jucha_date + kor_date + " 분석을 시작하겠습니다.");
	        
	        row = summary_sheet.createRow(Sheet2_Row+3);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+3).getCell(1).setCellValue("BTC 기준 시가 대비 종가 " + excel_map.get("summary_1_1") + kor_jucha_date + kor_date + " 바이낸스 선물 원화 코인 중 "+coin_total_count+"종 중 상승인 코인이 " + coin_increase_count + "종, 하락인 코인이 " + coin_degradation_count + "종, 보합인 코인이 " + coin_flat_count + "종입니다.");
	        ...
	        row = summary_sheet.createRow(Sheet2_Row+21);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+21).getCell(1).setCellValue(kor_jucha_date + kor_date + " 바이낸스 선물 코인 중 BTC가 " + excel_map.get("summary_1_1") + " 바이낸스 선물 원화 코인 "+coin_total_count+"종 중 상승인 코인이 " + coin_increase_count + "종, 하락인 코인이 " + coin_degradation_count + "종, 보합인 코인이 " + coin_flat_count + "종입니다.");
	        ...
	        fileName = "바이낸스_선물_Weekly_"+std_date+"_"+end_date+".xlsx";
	...
	public void ExcelMake_Monthly(HttpServletRequest req, HttpServletResponse response) throws Exception {
		...
		try {
	        ...
	        HashMap<String, String> excel_map = BinanceFuturesCoinService.ExcelMake_Monthly(map);
	        ...
	        form_sheet.getRow(Sheet1_Row).getCell(1).setCellValue("바이낸스 선물 월간 분석 " + std_date + " ~ " + end_date);
	        form_sheet.getRow(Sheet1_Row+3).getCell(2).setCellValue(coin_increase_count);
	        form_sheet.getRow(Sheet1_Row+3).getCell(3).setCellValue(coin_increase_ticker);
	        form_sheet.getRow(Sheet1_Row+5).getCell(2).setCellValue(coin_flat_count);
	        form_sheet.getRow(Sheet1_Row+5).getCell(3).setCellValue(coin_flat_ticker);
	        ...
	        Row row = summary_sheet.createRow(Sheet2_Row);
	        Cell cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row).getCell(1).setCellValue("바이낸스 선물 " + kor_month_date + " 코인 분석");
	        
	        row = summary_sheet.createRow(Sheet2_Row+1);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+1).getCell(1).setCellValue("바이낸스 선물 " + kor_month_date + kor_date + " 분석을 시작하겠습니다.");
	        
	        row = summary_sheet.createRow(Sheet2_Row+3);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+3).getCell(1).setCellValue("BTC 기준 시가 대비 종가 " + excel_map.get("summary_1_1") + kor_month_date + kor_date + " 바이낸스 선물 원화 코인 중 "+coin_total_count+"종 중 상승인 코인이 " + coin_increase_count + "종, 하락인 코인이 " + coin_degradation_count + "종, 보합인 코인이 " + coin_flat_count + "종입니다.");
	        ...
	        row = summary_sheet.createRow(Sheet2_Row+21);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+21).getCell(1).setCellValue(kor_month_date + kor_date + " 바이낸스 선물 코인 중 BTC가 " + excel_map.get("summary_1_1") + " 바이낸스 선물 원화 코인 "+coin_total_count+"종 중 상승인 코인이 " + coin_increase_count + "종, 하락인 코인이 " + coin_degradation_count + "종, 보합인 코인이 " + coin_flat_count + "종입니다.");
	        ...
	        fileName = "바이낸스_선물_Monthly_"+excel_title+".xlsx";
