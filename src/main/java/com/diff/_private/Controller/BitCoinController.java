...
public class BitCoinController {
	...
	public List<HashMap<String, String>> CoinInfo(HttpServletRequest req) throws Exception {
		return BitCoinService.CoinInfo();
	}
	...
	public List<HashMap<String, String>> MainLiveRankList(HttpServletRequest req) throws Exception {
		...
		return BitCoinService.MainLiveRankList(map);
	}
	...
	public void ExcelMake_Weekly(HttpServletRequest req, HttpServletResponse response) throws Exception {
		...
		try {
	        ...
	        List<HashMap<String, String>> result_map = BitCoinService.ExcelMake_Weekly_Result(map);
	        String coin_total_count = result_map.get(0).get("total_count");
	        String coin_increase_count = result_map.get(0).get("increase_count");
	        String coin_degradation_count = result_map.get(0).get("degradation_count");
	        String coin_flat_count = result_map.get(0).get("flat_count");
	        ...
	        List<HashMap<String, String>> ranking_list = BitCoinService.ExcelMake_Weekly_Ranking(map);
	        
	        String result_data = " "+coin_total_count+" | " + coin_increase_count +" | " + coin_degradation_count +" | " + coin_flat_count;
	        form_wb.setSheetName(0, result_data);
	        
	        HashMap<String, String> excel_map = BitCoinService.ExcelMake_Weekly(map);
	        ...
	        Row row = summary_sheet.createRow(Sheet2_Row);
	        Cell cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row).getCell(1).setCellValue("빗썸 " + kor_jucha_date + " 코인 분석");
	        
	        row = summary_sheet.createRow(Sheet2_Row+1);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+1).getCell(1).setCellValue("빗썸 " + kor_jucha_date + kor_date + " 분석을 시작하겠습니다.");
	        
	        row = summary_sheet.createRow(Sheet2_Row+3);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+3).getCell(1).setCellValue("BTC 기준 시가 대비 종가 " + excel_map.get("summary_1_1") + kor_jucha_date + kor_date + " 빗썸 원화 코인 중 "+coin_total_count+"종 중 상승인 코인이 " + coin_increase_count + "종, 하락인 코인이 " + coin_degradation_count + "종, 보합인 코인이 " + coin_flat_count + "종입니다.");
	        ...
	        row = summary_sheet.createRow(Sheet2_Row+21);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+21).getCell(1).setCellValue(kor_jucha_date + kor_date + " 빗썸 코인 중 BTC가 " + excel_map.get("summary_1_1") + " 빗썸 원화 코인 "+coin_total_count+"종 중 상승인 코인이 " + coin_increase_count + "종, 하락인 코인이 " + coin_degradation_count + "종, 보합인 코인이 " + coin_flat_count + "종입니다.");
	        ...
	        fileName = "빗썸_Weekly_"+std_date+"_"+end_date+".xlsx";
	...
	public void ExcelMake_Monthly(HttpServletRequest req, HttpServletResponse response) throws Exception {
		...
		try {
	        ...
	        HashMap<String, String> excel_map = BitCoinService.ExcelMake_Monthly(map);
	        ...
	        Row row = summary_sheet.createRow(Sheet2_Row);
	        Cell cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row).getCell(1).setCellValue("빗썸 " + kor_month_date + " 코인 분석");
	        
	        row = summary_sheet.createRow(Sheet2_Row+1);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+1).getCell(1).setCellValue("빗썸 " + kor_month_date + kor_date + " 분석을 시작하겠습니다.");
	        
	        row = summary_sheet.createRow(Sheet2_Row+3);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+3).getCell(1).setCellValue("BTC 기준 시가 대비 종가 " + excel_map.get("summary_1_1") + kor_month_date + kor_date + " 빗썸 원화 코인 중 "+coin_total_count+"종 중 상승인 코인이 " + coin_increase_count + "종, 하락인 코인이 " + coin_degradation_count + "종, 보합인 코인이 " + coin_flat_count + "종입니다.");
	        ...
	        row = summary_sheet.createRow(Sheet2_Row+21);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+21).getCell(1).setCellValue(kor_month_date + kor_date + " 빗썸 코인 중 BTC가 " + excel_map.get("summary_1_1") + " 빗썸 원화 코인 "+coin_total_count+"종 중 상승인 코인이 " + coin_increase_count + "종, 하락인 코인이 " + coin_degradation_count + "종, 보합인 코인이 " + coin_flat_count + "종입니다.");
	        ...
	        fileName = "빗썸_Monthly_"+excel_title+".xlsx";
