...
public class BitCoinController {
	...
	public void ExcelMake_Daily(HttpServletRequest req, HttpServletResponse response) throws Exception {
		...
		try {
			...
			InputStream fis = new FileInputStream(new File(path+"/Excel/B_Daily.xlsx"));
	        ...
	        String result_data = BitCoinService.ExcelMake_Daily_Result(map);
	        ...
	        form_sheet.getRow(1).getCell(1).setCellValue("빗썸 일일 분석 " + date);
	        ...
	        summary_sheet.getRow(1).getCell(1).setCellValue("빗썸 " + kor_date + " 코인 분석");
	        
	        row = summary_sheet.createRow(2);
	        cell = row.createCell(1);
	        summary_sheet.getRow(2).getCell(1).setCellValue("빗썸 " + kor_date + " 코인 분석을 시작하겠습니다.");
	        ...
	        cell = row.createCell(1);
	        summary_sheet.getRow(4).getCell(1).setCellValue("BTC 기준 시가 대비 종가 " + excel_map.get("summary_1_1") + kor_date+ " 빗썸 원화 코인 중 243종 중 시가 대비 종가가 " + result_data.replace("상승 = ", "상승인 코인이 ").replace(" | 하락 = ", "종, 하락인 코인이 ").replace(" | 보합 = ", "종, 보합인 코인이 ") + "종입니다.");
	        ...
	        cell = row.createCell(1);
	        summary_sheet.getRow(21).getCell(1).setCellValue(kor_date + " 빗썸 코인 중 BTC가 " + excel_map.get("summary_1_1") + " 빗썸 원화 코인 243종 중 " + result_data.replace("상승 = ", "상승인 코인이 ").replace(" | 하락 = ", "종, 하락인 코인이 ").replace(" | 보합 = ", "종, 보합인 코인이 ") + "종입니다.");
	...
	public void ExcelMake_Weekly(HttpServletRequest req, HttpServletResponse response) throws Exception {
		...
		try {
	        ...
	        String result_data = BitCoinService.ExcelMake_Weekly_Result(map);
	        form_wb.setSheetName(0, result_data);
	        ...
	        form_sheet.getRow(1).getCell(1).setCellValue("빗썸 주간 분석 " + std_date + " ~ " + end_date);
	        form_sheet.getRow(4).getCell(2).setCellValue(excel_map.get("btc_ticker"));
	        form_sheet.getRow(6).getCell(3).setCellValue(excel_map.get("btc_o_price"));
	        form_sheet.getRow(6).getCell(7).setCellValue(excel_map.get("btc_c_price"));
	        form_sheet.getRow(7).getCell(3).setCellValue(excel_map.get("btc_l_price"));
	        ...
	        Row row = summary_sheet.createRow(1);
	        Cell cell = row.createCell(1);
	        summary_sheet.getRow(1).getCell(1).setCellValue("빗썸 " + kor_jucha_date + " 코인 분석");
	        
	        row = summary_sheet.createRow(2);
	        cell = row.createCell(1);
	        summary_sheet.getRow(2).getCell(1).setCellValue("빗썸 " + kor_jucha_date + kor_date + " 분석을 시작하겠습니다.");
	        ...
	        row = summary_sheet.createRow(4);
	        cell = row.createCell(1);
	        summary_sheet.getRow(4).getCell(1).setCellValue("BTC 기준 시가 대비 종가 " + excel_map.get("summary_1_1") + kor_jucha_date + kor_date + " 빗썸 원화 코인 중 243종 중 시가 대비 종가가 " + result_data.replace("상승 = ", "상승인 코인이 ").replace(" | 하락 = ", "종, 하락인 코인이 ").replace(" | 보합 = ", "종, 보합인 코인이 ") + "종입니다.");
	        ...
	        cell = row.createCell(1);
	        summary_sheet.getRow(22).getCell(1).setCellValue(kor_jucha_date + kor_date + " 빗썸 코인 중 BTC가 " + excel_map.get("summary_1_1") + " 빗썸 원화 코인 116종 중 " + result_data.replace("상승 = ", "상승인 코인이 ").replace(" | 하락 = ", "종, 하락인 코인이 ").replace(" | 보합 = ", "종, 보합인 코인이 ") + "종입니다.");
