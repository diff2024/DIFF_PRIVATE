...
public class CoinController {
	...
	public List<HashMap<String, String>> MainLiveRankList(HttpServletRequest req) throws Exception {
		...
		return CoinService.MainLiveRankList(map);
	}
	...
	public void ExcelMake_Daily(HttpServletRequest req, HttpServletResponse response) throws Exception {
		...
		try {
	        ...
	        List<HashMap<String, String>> result_map = CoinService.ExcelMake_Daily_Result(map);
	        ...
	        List<HashMap<String, String>> ranking_list = CoinService.ExcelMake_Daily_Ranking(map);
	...
	public void ExcelMake_Weekly(HttpServletRequest req, HttpServletResponse response) throws Exception {
		...
		try {
	        ...
	        List<HashMap<String, String>> result_map = CoinService.ExcelMake_Weekly_Result(map);
	        String coin_total_count = result_map.get(0).get("total_count");
	        String coin_increase_count = result_map.get(0).get("increase_count");
	        String coin_degradation_count = result_map.get(0).get("degradation_count");
	        String coin_flat_count = result_map.get(0).get("flat_count");
	        ...
	        List<HashMap<String, String>> ranking_list = CoinService.ExcelMake_Weekly_Ranking(map);
	        ...
	        form_sheet.getRow(Sheet1_Row).getCell(1).setCellValue("업비트 주간 분석 " + std_date + " ~ " + end_date);
	        form_sheet.getRow(Sheet1_Row+3).getCell(2).setCellValue(coin_increase_count);
	        form_sheet.getRow(Sheet1_Row+3).getCell(3).setCellValue(coin_increase_ticker);
	        form_sheet.getRow(Sheet1_Row+5).getCell(2).setCellValue(coin_flat_count);
	        form_sheet.getRow(Sheet1_Row+5).getCell(3).setCellValue(coin_flat_ticker);
	        ...
	        Row row = summary_sheet.createRow(Sheet2_Row);
	        Cell cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row).getCell(1).setCellValue("업비트 " + kor_jucha_date + " 코인 분석");
	        
	        row = summary_sheet.createRow(Sheet2_Row+1);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+1).getCell(1).setCellValue("업비트 " + kor_jucha_date + kor_date + " 분석을 시작하겠습니다.");
	        
	        row = summary_sheet.createRow(Sheet2_Row+3);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+3).getCell(1).setCellValue("BTC 기준 시가 대비 종가 " + excel_map.get("summary_1_1") + kor_jucha_date + kor_date + " 업비트 원화 코인 중 "+coin_total_count+"종 중 상승인 코인이 " + coin_increase_count + "종, 하락인 코인이 " + coin_degradation_count + "종, 보합인 코인이 " + coin_flat_count + "종입니다.");
	        ...
	        row = summary_sheet.createRow(Sheet2_Row+21);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+21).getCell(1).setCellValue(kor_jucha_date + kor_date + " 업비트 코인 중 BTC가 " + excel_map.get("summary_1_1") + " 업비트 원화 코인 "+coin_total_count+"종 중 상승인 코인이 " + coin_increase_count + "종, 하락인 코인이 " + coin_degradation_count + "종, 보합인 코인이 " + coin_flat_count + "종입니다.");
	        ...
	        fileName = "업비트_Weekly_"+std_date+"_"+end_date+".xlsx";
	...
	public void ExcelMake_Monthly(HttpServletRequest req, HttpServletResponse response) throws Exception {
		...
		try {
	        ...
	        HashMap<String, String> excel_map = CoinService.ExcelMake_Monthly(map);
	        ...
	        form_sheet.getRow(Sheet1_Row).getCell(1).setCellValue("업비트 월간 분석 " + std_date + " ~ " + end_date);
	        form_sheet.getRow(Sheet1_Row+3).getCell(2).setCellValue(coin_increase_count);
	        form_sheet.getRow(Sheet1_Row+3).getCell(3).setCellValue(coin_increase_ticker);
	        form_sheet.getRow(Sheet1_Row+5).getCell(2).setCellValue(coin_flat_count);
	        form_sheet.getRow(Sheet1_Row+5).getCell(3).setCellValue(coin_flat_ticker);
	        ...
	        Row row = summary_sheet.createRow(Sheet2_Row);
	        Cell cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row).getCell(1).setCellValue("업비트 " + kor_month_date + " 코인 분석");
	        
	        row = summary_sheet.createRow(Sheet2_Row+1);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+1).getCell(1).setCellValue("업비트 " + kor_month_date + kor_date + " 분석을 시작하겠습니다.");
	        
	        row = summary_sheet.createRow(Sheet2_Row+3);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+3).getCell(1).setCellValue("BTC 기준 시가 대비 종가 " + excel_map.get("summary_1_1") + kor_month_date + kor_date + " 업비트 원화 코인 중 "+coin_total_count+"종 중 상승인 코인이 " + coin_increase_count + "종, 하락인 코인이 " + coin_degradation_count + "종, 보합인 코인이 " + coin_flat_count + "종입니다.");
	        ...
	        row = summary_sheet.createRow(Sheet2_Row+21);
	        cell = row.createCell(1);
	        summary_sheet.getRow(Sheet2_Row+21).getCell(1).setCellValue(kor_month_date + kor_date + " 업비트 코인 중 BTC가 " + excel_map.get("summary_1_1") + " 업비트 원화 코인 "+coin_total_count+"종 중 상승인 코인이 " + coin_increase_count + "종, 하락인 코인이 " + coin_degradation_count + "종, 보합인 코인이 " + coin_flat_count + "종입니다.");
	        ...
	        fileName = "업비트_Monthly_"+excel_title+".xlsx";
