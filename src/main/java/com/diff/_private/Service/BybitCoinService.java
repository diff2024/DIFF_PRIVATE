...
import com.diff._private.Mapper.Main.BybitCoinMapper;

@Service
@Transactional
public class BybitCoinService {
	
	@Autowired
	BybitCoinMapper BybitCoinMapper;
	
	public List<HashMap<String, String>> CoinInfo() throws Exception{
		return BybitCoinMapper.CoinInfo();
	}
	...
	public String BlogUploadLogConfirm() throws Exception{
		return BybitCoinMapper.BlogUploadLogConfirm();
	}
	
	public String BlogUploadLogDeleteYN(HashMap<String, String> map) throws Exception{
		return BybitCoinMapper.BlogUploadLogDeleteYN(map);
	}
	...
	public void WordPressReportHTMLCreate(HashMap<String, String> map) throws Exception{
        ...
        List<HashMap<String, String>> coinDailyReportList = BybitCoinMapper.CoinDailyReportList(map);
        ...
        for(int x=0; x<coinDailyReportList.size(); x++) {
        	if ((coinDailyReportList.get(x).get("status")).equals("보합")) {
        		...
        		if(flat_coin.equals("")) {
        			flat_coin = (coinDailyReportList.get(x).get("coin_ticker")).replace("USDT", "");
        		} else {
        			flat_coin = flat_coin + ", " + (coinDailyReportList.get(x).get("coin_ticker")).replace("USDT", "");
        		}
        		...
        		if(degradation_coin.equals("")) {
        			degradation_coin = (coinDailyReportList.get(x).get("coin_ticker")).replace("USDT", "");
        		} else {
        			degradation_coin = degradation_coin + ", " + (coinDailyReportList.get(x).get("coin_ticker")).replace("USDT", "");
        		}
        	} else {
        		int_increase_count = int_increase_count+1;

        		if(increase_coin.equals("")) {
        			increase_coin = (coinDailyReportList.get(x).get("coin_ticker")).replace("USDT", "");
        		} else {
        			increase_coin = increase_coin + ", " + (coinDailyReportList.get(x).get("coin_ticker")).replace("USDT", "");
        		}
        	}
		...
		html = "<h1 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color:black; font-weight:bold;\">바이비트 "+kor_date+" 코인 분석</h1><br/>";
		...
		row = row+1;
		ReportNum = ReportNum+1;
		html = "<p id=\"report_"+Integer.toString(ReportNum)+"\" style=\"font-size:16px; color:black;\">바이비트 "+kor_date+" 코인 분석을 시작하겠습니다.</p>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		html = "";
		html += "<br/><table id=\"tbl_summary\" style=\"color:black; border-spacing:0px; border-color:black; padding: 10px;\">";
		html += "<colgroup>";
		...
		html += "</colgroup>";
		html += "<tr>";
		html += "<td colspan=\"8\" style=\"height:60px; border: 3px solid black; font-weight:bold; font-size: 28px; text-align:center;\">바이비트 일일 분석 "+date+"</td>";
		html += "</td>";
		html += "</tr>";
		html += "<tr>";
		html += "<td colspan=\"8\" style=\"height:15px;\"></td>";
		html += "</td>";
		html += "</tr>";
		html += "<tr>";
		...
		html += "<td colspan=\"6\" style=\"border: 1px solid black; border-top: 3px solid black; border-right: 3px solid black; color: black; font-size: 11px; padding-left:3px; padding-right:3px; padding-top: 5px; padding-bottom: 5px; white-space: pre-wrap; word-break: break-all;\">"+increase_coin+"</td>";
		html += "</tr>";
		html += "<tr>";
		...
		html += "<td colspan=\"6\" style=\"border: 1px solid black; border-right: 3px solid black; color: black; font-size: 11px; padding-left:3px; padding-right:3px; padding-top: 10px; padding-bottom: 10px; white-space: pre-wrap; word-break: break-all;\">"+flat_coin+"</td>";
		html += "</tr>";
		html += "<tr>";
		...
		html += "<td colspan=\"6\" style=\"border: 1px solid black; border-bottom: 3px solid black; border-right: 3px solid black; color: black; font-size: 11px; padding-left:3px; padding-right:3px; padding-top: 5px; padding-bottom: 5px; white-space: pre-wrap; word-break: break-all;\">"+degradation_coin+"</td>";
		html += "</tr>";
		html += "</table><br/>";
		...
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", "bybit_summary.png");
		...
		html = "";
		html += "<br/><table id=\"btc_tbl_main\" style=\"color:black; border-spacing:0px; border-color:black; font-size:13px; padding: 15px;\">";
		html += "<colgroup>";
		...
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", "bybit_btc_main.png");
		htmlMap.put("diff_yn", "N");
		htmlMap.put("blog_yn", "Y");
		list.add(htmlMap);
		
		html  = "";
		html += "<table id=\"btc_tbl_sub\" style=\"color:black; border-spacing:0px; border-color:black; font-size:13px; padding: 15px;\">";
		html += "<colgroup>";
		...
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", "bybit_btc_sub.png");
		htmlMap.put("diff_yn", "N");
		htmlMap.put("blog_yn", "Y");
		list.add(htmlMap);
		...
		html = "<p id=\"report_"+Integer.toString(ReportNum)+"\" style=\"font-size:16px; color:black;\">BTC 기준 시가 대비 종가 "+o_c_price_rate+"% "+status+"하였으며, "+kor_date+" 바이비트 USDT 코인 "+total_count+"종 중 <span style=\"color: #ee2323;\"><b>상승인 코인이 "+increase_count+"종</b></span>, <span style=\"color: #006dd7;\"><b>하락인 코인이 "+degradation_count+"종</b></span>, <b>보합인 코인이 "+flat_count+"종</b>입니다.<br />"+kor_date+"에 투자했으면 가장 안정적으로 많이 벌 수 있었던 코인 순위를 알려드리겠습니다.<br />오늘 코인 매매 시 한 번 고려 해보시기 바랍니다.</p>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		html = short_kor_date+ " 비트코인 기준 시가 대비 종가 "+o_c_price_rate+"% "+status+"하였으며, 바이비트 USDT 코인 "+total_count+"종 중 상승인 코인이 "+increase_count+"종, 하락인 코인이 "+degradation_count+"종, 보합인 코인이 "+flat_count+"종입니다.";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "excerpt");
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", html);
		htmlMap.put("diff_yn", "N");
		...
		for(int x=Integer.parseInt(MainRankingCount); x>=1; x--) {
			...
			html = "";
			html += "<br/><table id=\"coin_"+ranking+"_tbl_main\" style=\"color:black; border-spacing:0px; border-color:black; font-size:13px; padding: 15px;\">";
			html += "<colgroup>";
			html += "<col style=\"width: 60px\">";
			html += "<col style=\"width: 60px\">";
			html += "<col style=\"width: 80px\">";
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "bybit_coin"+ranking+"_main.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
			
			html  = "";
			html += "<table id=\"coin_"+ranking+"_tbl_sub\" style=\"color:black; border-spacing:0px; border-color:black; font-size:13px; padding: 15px;\">";
			html += "<colgroup>";
			html += "<col style=\"width: 95px\">";
			html += "<col style=\"width: 90px\">";
			html += "<col style=\"width: 90px\">";
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "bybit_coin"+ranking+"_sub.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
			...
			html = "<p id=\"report_"+Integer.toString(ReportNum)+"\" style=\"font-size:16px; color:black;\">"+kor_date+" "+ranking+"순위는 "+coinKorName+"로, 시가 대비 종가가 "+o_c_price_rate+"%, 저가 대비 고가가 "+l_h_price_rate+"%이며, 가장 좋은 타이밍은 "+lower_price_time.replace(":","시 ")+"분에 "+l_price+"USDT로 매수하여 "+higher_price_time.replace(":","시 ")+"분에 "+h_price+"USDT로 매도하면 대략 "+l_h_price_rate+"%의 수익을 얻을 수 있었습니다.</p><br/><br/>";
			htmlMap = new HashMap<String, String>();
			htmlMap.put("id", "report_"+Integer.toString(ReportNum));
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			...
			if(x == 2) {
				...
				html = (map.get("BybitReportAD1")+"<br>");
				htmlMap = new HashMap<String, String>();
				htmlMap.put("id", "ad1");
				htmlMap.put("row", Integer.toString(row));
				htmlMap.put("col", "0");
		...
		row = row+1;
		ReportNum = ReportNum+1;
		html = "<br/><h2 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color: black; text-align: start; font-size:23px;\"><b>"+short_kor_date+" 바이비트 코인 요약</b></h2><br/>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		html = "<br/><h2 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color: black; text-align: start; font-size:23px; margin-top:0px;\"><b>"+short_kor_date+" 바이비트 코인 요약</b></h2>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		row = row+1;
		ReportNum = ReportNum+1;
		html = "<p id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color:black; font-size:16px;\">"+kor_date+" 바이비트 USDT 코인 "+total_count+"종 중 <span style=\"color: #ee2323;\"><b>상승인 코인이 "+increase_count+"종</b></span>, <span style=\"color: #006dd7;\"><b>하락인 코인이 "+degradation_count+"종</b></span>, <b>보합인 코인이 "+flat_count+"종</b>입니다.</p>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		row = row+1;
		ReportNum = ReportNum+1;
		html = "<br/><h2 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color: black; text-align: start; font-size:23px;\"><b>"+short_kor_date+" 바이비트 코인 상승률 순위</b></h2><br/>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		html = "<br/><h2 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color: black; text-align: start; font-size:23px; margin-top:0px;\"><b>"+short_kor_date+" 바이비트 코인 상승률 순위</b></h2>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		if(SubRankingCount.equals("0")) {
			SubRankingCount = total_count;
		}
		...
		for(int x=1; x<=SubRankingMok; x++) {
			...
			for(int y=0; y<20; y++) {
				...
				if(TMPy > (Integer.parseInt(SubRankingCount)-1)) {
					...
					} else if(ranking_o_c_price_rate.equals("0")){
						html += "<td style=\"border: 1px solid black; border-right:0px solid black; border-top:0px solid black; padding-right:3px; text-align:right; color:black;\">"+ranking_o_c_price_rate+"%</td>";
					} else {
					...
					} else if(ranking_l_h_price_rate.equals("0")){
						html += "<td style=\"border: 1px solid black; border-right:0px solid black; border-top:0px solid black; padding-right:3px; text-align:right; color:black;\">"+ranking_l_h_price_rate+"%</td>";
					} else {
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "bybit_rank_"+Integer.toString(x)+".png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
		...
		for(int x=0; x<list.size(); x++) {
			...
			if(!script_id.equals("") && !script_row.equals("") && !script_col.equals("") && !script_html.equals("")) {
				...
				htmlMap.put("blog_id", blog_id);
				BybitCoinMapper.WordPressReportHTMLCreate(htmlMap);
			}
		}
	}
	...
	public void TiStoryReportHTMLCreate(HashMap<String, String> map) throws Exception{
		...
		html = "<div id=\"bybit_hour_graph_script\"></div>";
		row = row+1;
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "bybit_hour_graph_script");
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", html);
		htmlMap.put("diff_yn", "Y");
		...
		html = "<div id=\"bybit_4hour_graph_script\"></div>";
		row = row+1;
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "bybit_4hour_graph_script");
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", html);
		htmlMap.put("diff_yn", "Y");
		...
		html = "<div id=\"bybit_day_graph_script\"></div>";
		row = row+1;
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "bybit_day_graph_script");
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", html);
		htmlMap.put("diff_yn", "Y");
		...
		row = row+1;
		ReportNum = ReportNum+1;
		html = "<p id=\"report_"+Integer.toString(ReportNum)+"\" style=\"font-size:18px; color:black;\">바이비트 "+kor_date+" 코인 분석을 시작하겠습니다.</p>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", "t_bybit_summary.png");
		htmlMap.put("diff_yn", "N");
		htmlMap.put("blog_yn", "Y");
		list.add(htmlMap);
		...
		row = row+1;
		ReportNum = ReportNum+1;
		html = "<h2 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"font-size:25px; color:black;\"><b>"+short_kor_date+" "+coinTitle+"</b></h2>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		html = "<h2 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"font-size:25px; color:black; margin-top:0px;\"><b><br/>"+short_kor_date+" "+coinTitle+"</b></h2>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", "t_bybit_btc_main.png");
		htmlMap.put("diff_yn", "N");
		htmlMap.put("blog_yn", "Y");
		list.add(htmlMap);
		...
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", "t_bybit_btc_sub.png");
		htmlMap.put("diff_yn", "N");
		htmlMap.put("blog_yn", "Y");
		list.add(htmlMap);
		...
		row = row+1;
		ReportNum = ReportNum+1;
		html = "<p id=\"report_"+Integer.toString(ReportNum)+"\" style=\"font-size:18px; color:black;\">BTC 기준 시가 대비 종가 "+o_c_price_rate+"% "+status+"하였으며, "+kor_date+" 바이비트 USDT 코인 "+total_count+"종 중 <span style=\"color: #ee2323;\"><b>상승인 코인이 "+increase_count+"종</b></span>, <span style=\"color: #006dd7;\"><b>하락인 코인이 "+degradation_count+"종</b></span>, <b>보합인 코인이 "+flat_count+"종</b>입니다.</p>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		for(int x=Integer.parseInt(MainRankingCount); x>=1; x--) {
			...
			row = row+1;
			ReportNum = ReportNum+1;
			html = "<br/><h2 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"font-size:25px; color:black;\"><b>"+short_kor_date+" "+ranking+"순위 "+coinTitle+"</b></h2>";
			htmlMap = new HashMap<String, String>();
			htmlMap.put("id", "report_"+Integer.toString(ReportNum));
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			...
			html = "<br/><h2 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"font-size:25px; color:black; margin-top:0px;\"><b>"+short_kor_date+" "+ranking+"순위 "+coinTitle+"</b></h2>";
			htmlMap = new HashMap<String, String>();
			htmlMap.put("id", "report_"+Integer.toString(ReportNum));
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_bybit_coin"+ranking+"_main.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_bybit_coin"+ranking+"_sub.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
			
			// 일시적으로 4시간봉 사용 안함
			html = "<div style=\"text-align:left; padding:0px; width:900px;\" id=\"bybit_4hour_rank"+ranking+"_graph\" style=\"display:none;\"></div>";
			
			row = row+1;
			htmlMap = new HashMap<String, String>();
			htmlMap.put("id", "bybit_4hour_rank"+ranking+"_graph");
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", html);
			htmlMap.put("diff_yn", "N");
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_bybit_4hour_rank"+ranking+"_graph.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "N");
			list.add(htmlMap);
			
			html = "<div style=\"text-align:left; padding:0px; width:900px;\" id=\"bybit_hour_rank"+ranking+"_graph\"></div>";
			
			row = row+1;
			htmlMap = new HashMap<String, String>();
			htmlMap.put("id", "bybit_hour_rank"+ranking+"_graph");
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", html);
			htmlMap.put("diff_yn", "Y");
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_bybit_hour_rank"+ranking+"_graph.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
			...
			row = row+1;
			ReportNum = ReportNum+1;
			html = "<p id=\"report_"+Integer.toString(ReportNum)+"\" style=\"font-size:18px; color:black; margin:0px;\">"+kor_date+" 수익률 "+ranking+"순위는 "+coinKorName+"로, 시가 대비 종가가 "+o_c_price_rate+"%, 저가 대비 고가가 "+l_h_price_rate+"%이며, "+lower_price_time.replace(":","시 ")+"분에 "+l_price+"USDT로 매수하여 "+higher_price_time.replace(":","시 ")+"분에 "+h_price+"USDT로 매도하면 대략 "+l_h_price_rate+"%의 수익을 얻을 수 있었습니다.</p>";
			htmlMap = new HashMap<String, String>();
			htmlMap.put("id", "report_"+Integer.toString(ReportNum));
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
		...
		row = row+1;
		ReportNum = ReportNum+1;
		html = "<br/><h2 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color: black; text-align: start; font-size:25px;\"><b>"+short_kor_date+" 바이비트 코인 요약</b></h2><br/>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		html = "<br/><h2 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color: black; text-align: start; font-size:25px; margin-top:0px;\"><b>"+short_kor_date+" 바이비트 코인 요약</b></h2>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		row = row+1;
		ReportNum = ReportNum+1;
		html = "<p id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color:black; font-size:18px;\">"+kor_date+" 바이비트 USDT 코인 "+total_count+"종 중 <span style=\"color: #ee2323;\"><b>상승인 코인이 "+increase_count+"종</b></span>, <span style=\"color: #006dd7;\"><b>하락인 코인이 "+degradation_count+"종</b></span>, <b>보합인 코인이 "+flat_count+"종</b>입니다.</p>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		row = row+1;
		ReportNum = ReportNum+1;
		html = "<br/><h2 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color: black; text-align: start; font-size:25px;\"><b>"+short_kor_date+" 바이비트 코인 상승률 순위</b></h2><br/>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		html = "<br/><h2 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color: black; text-align: start; font-size:25px; margin-top:0px;\"><b>"+short_kor_date+" 바이비트 코인 상승률 순위</b></h2>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		for(int x=1; x<=SubRankingMok; x++) {
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_bybit_rank_"+Integer.toString(x)+".png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
			
			html = "<div style=\"text-align:left; padding:0px; width:900px;\" id=\"bybit_day_rank_"+graph_ranking+"_graph\"></div>";
			
			row = row+1;
			htmlMap = new HashMap<String, String>();
			htmlMap.put("id", "bybit_day_rank_"+graph_ranking+"_graph");
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", html);
			htmlMap.put("diff_yn", "Y");
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_bybit_day_rank_"+graph_ranking+"_graph.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
			...
			for(int y=0; y<20; y++) {
				...
				if(TMPy > (Integer.parseInt(SubRankingCount)-1)) {
					...
					ReportNum = ReportNum+1;
					if(ranking_yesterday_ranking.equals("")) {
						html = "<p id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color:black; font-size:18px; margin-top:5px !important; margin-bottom:5px !important;\">"+ranking_ranking+"위는 "+ranking_coin_title+"로 "+ranking_o_c_price_rate+"%입니다.</p>";
					} else {
						html = "<p id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color:black; font-size:18px; margin-top:5px !important; margin-bottom:5px !important;\">"+ranking_ranking+"위는 "+ranking_coin_title+"로 "+ranking_o_c_price_rate+"%이며, 어제["+yesterday_short_kor_date+"]는 "+ranking_yesterday_o_c_price_rate+"%로 "+ranking_yesterday_ranking+"등을 했습니다.</p>";
					}
					if(y == 19) {
						html += "<br/>";
					}
	...
	public HashMap<String, String> ExcelMake_Daily(HashMap<String, String> map) throws Exception{
		...
		List<HashMap<String, String>> list = BybitCoinMapper.ExcelMake_Daily(map);
		...
		for(int x=0; x<list.size(); x++) {
			...
			if(coin_ticker.equals("BTCUSDT")) {
				...
				List<HashMap<String, String>> list_sub = BybitCoinMapper.ExcelMake_Daily_Sub(sub_map);
				...
				excel_map.put("coin1_ticker", list.get(x).get("coin_kor_name") + " ["+ (list.get(x).get("coin_ticker")).replace("USDT","") +"]");
				...
				excel_map.put("coin2_ticker", list.get(x).get("coin_kor_name") + " ["+ (list.get(x).get("coin_ticker")).replace("USDT","") +"]");
				...
				excel_map.put("coin3_ticker", list.get(x).get("coin_kor_name") + " ["+ (list.get(x).get("coin_ticker")).replace("USDT","") +"]");
	...
	public HashMap<String, String> ExcelMake_Weekly(HashMap<String, String> map) throws Exception{
		...
		for(int x=0; x<list.size(); x++) {
			...
			if(coin_ticker.equals("BTCUSDT")) {
				...
				List<HashMap<String, String>> list_sub = BybitCoinMapper.ExcelMake_Weekly_Sub(sub_map);
				...
				excel_map.put("coin1_summary", "1순위는 "+list.get(x).get("coin_kor_name")+"로, 시가 대비 종가가 " + df.format(Double.parseDouble(list.get(x).get("open_close_rate"))) + "%, 저가 대비 고가가 "+df.format(Double.parseDouble(list.get(x).get("lowest_highest_fluctuation")))+"%이며, 가장 좋은 타이밍은 "+(list.get(x).get("min_date")).replace("-", "년 ").replace("-", "월 ")+"일에 "+df.format(Double.parseDouble(list.get(x).get("l_price")))+"USDT로 매수하여 "+(list.get(x).get("max_date")).replace("-", "년 ").replace("-", "월 ")+"일에 "+df.format(Double.parseDouble(list.get(x).get("h_price")))+"USDT로 매도하면 대략 "+df.format(Double.parseDouble(list.get(x).get("lowest_highest_fluctuation")))+"%의 수익을 얻을 수 있었습니다.");
	...
	public HashMap<String, String> ExcelMake_Monthly(HashMap<String, String> map) throws Exception{
		...
		for(int x=0; x<list.size(); x++) {
			...
			if(coin_ticker.equals("BTCUSDT")) {
				...
				List<HashMap<String, String>> list_sub = BybitCoinMapper.ExcelMake_Monthly_Sub(sub_map);
				for(int y=0; y<list_sub.size(); y++) {
					excel_map.put("btc_oclh_"+Integer.toString(y+1)+"_date", list_sub.get(y).get("datetime_kst"));
					excel_map.put("btc_oclh_"+Integer.toString(y+1)+"_o_price", df.format(Double.parseDouble(list_sub.get(y).get("o_price"))));
					excel_map.put("btc_oclh_"+Integer.toString(y+1)+"_c_price", df.format(Double.parseDouble(list_sub.get(y).get("c_price"))));
