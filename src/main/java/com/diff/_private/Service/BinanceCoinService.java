...
public class BinanceCoinService {
	...
	public void CoinAnalysisDelete(HashMap<String, String> map) throws Exception{
		...
		BinanceCoinMapper.CoinAnalysisHourGraphDelete(map);
		BinanceCoinMapper.CoinAnalysis4HourGraphDelete(map);
		BinanceCoinMapper.WordPressReportHTMLDelete(map);
		BinanceCoinMapper.TiStoryReportHTMLDelete(map);
	}
	
	public void CoinAnalysisCreate(HashMap<String, String> map) throws Exception{
		BinanceCoinMapper.CoinAnalysisCreate(map);
	}
	
	public void CoinAnalysisHourGraphCreate(HashMap<String, String> map) throws Exception{
		BinanceCoinMapper.CoinAnalysisHourGraphCreate(map);
	}
	
	public void CoinAnalysis4HourGraphCreate(HashMap<String, String> map) throws Exception{
		BinanceCoinMapper.CoinAnalysis4HourGraphCreate(map);
	}
	...
	public void WordPressReportHTMLCreate(HashMap<String, String> map) throws Exception{
		...
		html = "<h1 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color:black; font-weight:bold;\">바이낸스 "+kor_date+" 코인 분석</h1><br/>";
		...
		row = row+1;
		ReportNum = ReportNum+1;
		html = "<p id=\"report_"+Integer.toString(ReportNum)+"\" style=\"font-size:16px; color:black;\">바이낸스 "+kor_date+" 코인 분석을 시작하겠습니다.</p>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		html += "</colgroup>";
		html += "<tr>";
		html += "<td colspan=\"8\" style=\"height:60px; border: 3px solid black; font-weight:bold; font-size: 28px; text-align:center;\">바이낸스 일일 분석 "+date+"</td>";
		html += "</td>";
		html += "</tr>";
		html += "<tr>";
		...
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", "binance_summary.png");
		...
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", "binance_btc_main.png");
		htmlMap.put("diff_yn", "N");
		htmlMap.put("blog_yn", "Y");
		list.add(htmlMap);
		...
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", "binance_btc_sub.png");
		htmlMap.put("diff_yn", "N");
		htmlMap.put("blog_yn", "Y");
		list.add(htmlMap);
		...
		html = "<p id=\"report_"+Integer.toString(ReportNum)+"\" style=\"font-size:16px; color:black;\">BTC 기준 시가 대비 종가 "+o_c_price_rate+"% "+status+"하였으며, "+kor_date+" 바이낸스 USDT 코인 "+total_count+"종 중 <span style=\"color: #ee2323;\"><b>상승인 코인이 "+increase_count+"종</b></span>, <span style=\"color: #006dd7;\"><b>하락인 코인이 "+degradation_count+"종</b></span>, <b>보합인 코인이 "+flat_count+"종</b>입니다.<br />"+kor_date+"에 투자했으면 가장 안정적으로 많이 벌 수 있었던 코인 순위를 알려드리겠습니다.<br />오늘 코인 매매 시 한 번 고려 해보시기 바랍니다.</p>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		html = short_kor_date+ " 비트코인 기준 시가 대비 종가 "+o_c_price_rate+"% "+status+"하였으며, 바이낸스 USDT 코인 "+total_count+"종 중 상승인 코인이 "+increase_count+"종, 하락인 코인이 "+degradation_count+"종, 보합인 코인이 "+flat_count+"종입니다.";
		htmlMap = new HashMap<String, String>();
		...
		for(int x=Integer.parseInt(MainRankingCount); x>=1; x--) {
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "binance_coin"+ranking+"_main.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "binance_coin"+ranking+"_sub.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
			...
			if(x == 2) {
				...
				html = (map.get("BinanceReportAD1")+"<br>");
				htmlMap = new HashMap<String, String>();
				htmlMap.put("id", "ad1");
				htmlMap.put("row", Integer.toString(row));
				htmlMap.put("col", "0");
		...
		row = row+1;
		ReportNum = ReportNum+1;
		html = "<br/><h2 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color: black; text-align: start; font-size:23px;\"><b>"+short_kor_date+" 바이낸스 코인 요약</b></h2><br/>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		html = "<br/><h2 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color: black; text-align: start; font-size:23px; margin-top:0px;\"><b>"+short_kor_date+" 바이낸스 코인 요약</b></h2>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		row = row+1;
		ReportNum = ReportNum+1;
		html = "<p id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color:black; font-size:16px;\">"+kor_date+" 바이낸스 USDT 코인 "+total_count+"종 중 <span style=\"color: #ee2323;\"><b>상승인 코인이 "+increase_count+"종</b></span>, <span style=\"color: #006dd7;\"><b>하락인 코인이 "+degradation_count+"종</b></span>, <b>보합인 코인이 "+flat_count+"종</b>입니다.</p>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		row = row+1;
		ReportNum = ReportNum+1;
		html = "<br/><h2 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color: black; text-align: start; font-size:23px;\"><b>"+short_kor_date+" 바이낸스 코인 상승률 순위</b></h2><br/>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		html = "<br/><h2 id=\"report_"+Integer.toString(ReportNum)+"\" style=\"color: black; text-align: start; font-size:23px; margin-top:0px;\"><b>"+short_kor_date+" 바이낸스 코인 상승률 순위</b></h2>";
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "report_"+Integer.toString(ReportNum));
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		...
		for(int x=1; x<=SubRankingMok; x++) {
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "binance_rank_"+Integer.toString(x)+".png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
		...
		for(int x=0; x<list.size(); x++) {
			...
			if(!script_id.equals("") && !script_row.equals("") && !script_col.equals("") && !script_html.equals("")) {
				...
				BinanceCoinMapper.WordPressReportHTMLCreate(htmlMap);
			}
		}
	}
	...
	public void TiStoryReportHTMLCreate(HashMap<String, String> map) throws Exception{
		...
		html = "<div id=\"binance_hour_graph_script\"></div>";
		row = row+1;
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "binance_hour_graph_script");
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", html);
		htmlMap.put("diff_yn", "Y");
		...
		html = "<div id=\"binance_4hour_graph_script\"></div>";
		row = row+1;
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "binance_4hour_graph_script");
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", html);
		htmlMap.put("diff_yn", "Y");
		...
		html = "<div id=\"binance_day_graph_script\"></div>";
		row = row+1;
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "binance_day_graph_script");
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", html);
		htmlMap.put("diff_yn", "Y");
		...
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", "t_binance_summary.png");
		htmlMap.put("diff_yn", "N");
		htmlMap.put("blog_yn", "Y");
		list.add(htmlMap);
		...
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", "t_binance_btc_main.png");
		htmlMap.put("diff_yn", "N");
		htmlMap.put("blog_yn", "Y");
		list.add(htmlMap);
		...
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", "t_binance_btc_sub.png");
		htmlMap.put("diff_yn", "N");
		htmlMap.put("blog_yn", "Y");
		list.add(htmlMap);
		...
		for(int x=Integer.parseInt(MainRankingCount); x>=1; x--) {
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_binance_coin"+ranking+"_main.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_binance_coin"+ranking+"_sub.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
			
			// 일시적으로 4시간봉 사용 안함
			html = "<div style=\"text-align:left; padding:0px; width:900px;\" id=\"binance_4hour_rank"+ranking+"_graph\" style=\"display:none;\"></div>";
			
			row = row+1;
			htmlMap = new HashMap<String, String>();
			htmlMap.put("id", "binance_4hour_rank"+ranking+"_graph");
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", html);
			htmlMap.put("diff_yn", "N");
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_binance_4hour_rank"+ranking+"_graph.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "N");
			list.add(htmlMap);
			
			html = "<div style=\"text-align:left; padding:0px; width:900px;\" id=\"binance_hour_rank"+ranking+"_graph\"></div>";
			
			row = row+1;
			htmlMap = new HashMap<String, String>();
			htmlMap.put("id", "binance_hour_rank"+ranking+"_graph");
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", html);
			htmlMap.put("diff_yn", "Y");
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_binance_hour_rank"+ranking+"_graph.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
			...
			row = row+1;
			ReportNum = ReportNum+1;
			html = "<p id=\"report_"+Integer.toString(ReportNum)+"\" style=\"font-size:16px; color:black; margin:0px;\">"+kor_date+" 수익률 "+ranking+"순위는 "+coinKorName+"로, 시가 대비 종가가 "+o_c_price_rate+"%, 저가 대비 고가가 "+l_h_price_rate+"%이며, "+lower_price_time.replace(":","시 ")+"분에 "+l_price+"USDT로 매수하여 "+higher_price_time.replace(":","시 ")+"분에 "+h_price+"USDT로 매도하면 대략 "+l_h_price_rate+"%의 수익을 얻을 수 있었습니다.</p>";
			htmlMap = new HashMap<String, String>();
			htmlMap.put("id", "report_"+Integer.toString(ReportNum));
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
		...
		for(int x=1; x<=SubRankingMok; x++) {
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_binance_rank_"+Integer.toString(x)+".png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
			
			html = "<div style=\"text-align:left; padding:0px; width:900px;\" id=\"binance_day_rank_"+graph_ranking+"_graph\"></div>";
			
			row = row+1;
			htmlMap = new HashMap<String, String>();
			htmlMap.put("id", "binance_day_rank_"+graph_ranking+"_graph");
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", html);
			htmlMap.put("diff_yn", "Y");
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_binance_day_rank_"+graph_ranking+"_graph.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
	...
	public HashMap<String, String> ExcelMake_Daily(HashMap<String, String> map) throws Exception{
		...
		List<HashMap<String, String>> list = BinanceCoinMapper.ExcelMake_Daily(map);
		...
		for(int x=0; x<list.size(); x++) {
			...
			if(coin_ticker.equals("BTCUSDT")) {
				...
				List<HashMap<String, String>> list_sub = BinanceCoinMapper.ExcelMake_Daily_Sub(sub_map);
	...
	public HashMap<String, String> ExcelMake_Weekly(HashMap<String, String> map) throws Exception{
		...
		for(int x=0; x<list.size(); x++) {
			...
			if(coin_ticker.equals("BTCUSDT")) {
				...
				List<HashMap<String, String>> list_sub = BinanceCoinMapper.ExcelMake_Weekly_Sub(sub_map);
	...
	public HashMap<String, String> ExcelMake_Monthly(HashMap<String, String> map) throws Exception{
		...
		for(int x=0; x<list.size(); x++) {
			...
			if(coin_ticker.equals("BTCUSDT")) {
				...
				List<HashMap<String, String>> list_sub = BinanceCoinMapper.ExcelMake_Monthly_Sub(sub_map);
				for(int y=0; y<list_sub.size(); y++) {
					excel_map.put("btc_oclh_"+Integer.toString(y+1)+"_date", list_sub.get(y).get("datetime_kst"));
					excel_map.put("btc_oclh_"+Integer.toString(y+1)+"_o_price", df.format(Double.parseDouble(list_sub.get(y).get("o_price"))));
					excel_map.put("btc_oclh_"+Integer.toString(y+1)+"_c_price", df.format(Double.parseDouble(list_sub.get(y).get("c_price"))));
