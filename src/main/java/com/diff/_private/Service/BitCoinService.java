...
import com.diff._private.Mapper.Main.BitCoinMapper;
...
public class BitCoinService {
	...
	public String BlogUploadLogConfirm() throws Exception{
		return BitCoinMapper.BlogUploadLogConfirm();
	}
	
	public String BlogUploadLogDeleteYN(HashMap<String, String> map) throws Exception{
		return BitCoinMapper.BlogUploadLogDeleteYN(map);
	}
	...
	public void CoinAnalysisHourGraphCreate(HashMap<String, String> map) throws Exception{
		BitCoinMapper.CoinAnalysisHourGraphCreate(map);
	}
	
	public void CoinAnalysis4HourGraphCreate(HashMap<String, String> map) throws Exception{
		BitCoinMapper.CoinAnalysis4HourGraphCreate(map);
	}
	...
	public void WordPressReportHTMLCreate(HashMap<String, String> map) throws Exception{
		...
		html = short_kor_date+ " 비트코인 기준 시가 대비 종가 "+o_c_price_rate+"% "+status+"하였으며, 빗썸 원화 코인 "+total_count+"종 중 상승인 코인이 "+increase_count+"종, 하락인 코인이 "+degradation_count+"종, 보합인 코인이 "+flat_count+"종입니다.";
		htmlMap = new HashMap<String, String>();
		...
		for(int x=Integer.parseInt(MainRankingCount); x>=1; x--) {
			...
			if(x == 2) {
				...
				html = (map.get("BithumbReportAD1")+"<br>");
				htmlMap = new HashMap<String, String>();
				htmlMap.put("id", "ad1");
				htmlMap.put("row", Integer.toString(row));
				htmlMap.put("col", "0");
		...
		for(int x=0; x<list.size(); x++) {
			...
			if(!script_id.equals("") && !script_row.equals("") && !script_col.equals("") && !script_html.equals("")) {
				...
				BitCoinMapper.WordPressReportHTMLCreate(htmlMap);
			}
		}
	}
	...
	public void TiStoryReportHTMLCreate(HashMap<String, String> map) throws Exception{
		...
		html = "<div id=\"bithumb_hour_graph_script\"></div>";
		row = row+1;
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "bithumb_hour_graph_script");
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", html);
		htmlMap.put("diff_yn", "Y");
		...
		html = "<div id=\"bithumb_4hour_graph_script\"></div>";
		row = row+1;
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "bithumb_4hour_graph_script");
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", html);
		htmlMap.put("diff_yn", "Y");
		...
		html = "<div id=\"bithumb_day_graph_script\"></div>";
		row = row+1;
		htmlMap = new HashMap<String, String>();
		htmlMap.put("id", "bithumb_day_graph_script");
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", html);
		htmlMap.put("diff_yn", "Y");
		...
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", "t_bithumb_summary.png");
		htmlMap.put("diff_yn", "N");
		htmlMap.put("blog_yn", "Y");
		list.add(htmlMap);
		...
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", "t_bithumb_btc_main.png");
		htmlMap.put("diff_yn", "N");
		htmlMap.put("blog_yn", "Y");
		list.add(htmlMap);
		...
		htmlMap.put("row", Integer.toString(row));
		htmlMap.put("col", "0");
		htmlMap.put("html", "t_bithumb_btc_sub.png");
		htmlMap.put("diff_yn", "N");
		htmlMap.put("blog_yn", "Y");
		list.add(htmlMap);
		...
		for(int x=Integer.parseInt(MainRankingCount); x>=1; x--) {
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_bithumb_coin"+ranking+"_main.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_bithumb_coin"+ranking+"_sub.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
			
			// 일시적으로 4시간봉 사용 안함
			html = "<div style=\"text-align:left; padding:0px; width:900px;\" id=\"bithumb_4hour_rank"+ranking+"_graph\" style=\"display:none;\"></div>";
			
			row = row+1;
			htmlMap = new HashMap<String, String>();
			htmlMap.put("id", "bithumb_4hour_rank"+ranking+"_graph");
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", html);
			htmlMap.put("diff_yn", "N");
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_bithumb_4hour_rank"+ranking+"_graph.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "N");
			list.add(htmlMap);
			
			html = "<div style=\"text-align:left; padding:0px; width:900px;\" id=\"bithumb_hour_rank"+ranking+"_graph\"></div>";
			
			row = row+1;
			htmlMap = new HashMap<String, String>();
			htmlMap.put("id", "bithumb_hour_rank"+ranking+"_graph");
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", html);
			htmlMap.put("diff_yn", "Y");
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_bithumb_hour_rank"+ranking+"_graph.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
		...
		for(int x=1; x<=SubRankingMok; x++) {
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_bithumb_rank_"+Integer.toString(x)+".png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
			
			html = "<div style=\"text-align:left; padding:0px; width:900px;\" id=\"bithumb_day_rank_"+graph_ranking+"_graph\"></div>";
			
			row = row+1;
			htmlMap = new HashMap<String, String>();
			htmlMap.put("id", "bithumb_day_rank_"+graph_ranking+"_graph");
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", html);
			htmlMap.put("diff_yn", "Y");
			...
			htmlMap.put("row", Integer.toString(row));
			htmlMap.put("col", "0");
			htmlMap.put("html", "t_bithumb_day_rank_"+graph_ranking+"_graph.png");
			htmlMap.put("diff_yn", "N");
			htmlMap.put("blog_yn", "Y");
			list.add(htmlMap);
		...
		for(int x=0; x<list.size(); x++) {
			...
			if(!script_id.equals("") && !script_row.equals("") && !script_col.equals("") && !script_html.equals("")) {
				...
				htmlMap.put("blog_yn", script_blog_yn);
				htmlMap.put("blog_id", blog_id);
				BitCoinMapper.TiStoryReportHTMLCreate(htmlMap);
			}
		}
	}
