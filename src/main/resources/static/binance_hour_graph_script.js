...
function drawChart() {
    ...
    fetch('/Main/BINANCE_BTC_HOUR_Ticker_Comparison?date='+date)
    ...
    .then((list) => {
        ...
        for(var x=0; x<Number(main_ranking); x++){
            ...
            var chart = new google.visualization.LineChart(document.getElementById('binance_hour_rank'+String(Number(x)+1)+'_graph'));
