...
function drawChart() {
    ...
    fetch('/Main/BINANCE_FUTURES_BTC_4HOUR_Ticker_Comparison?date='+date)
    ...
    .then((list) => {
        ...
        for(var x=0; x<Number(main_ranking); x++){
            ...
            var chart = new google.visualization.LineChart(document.getElementById('binance_futures_4hour_rank'+String(Number(x)+1)+'_graph'));
