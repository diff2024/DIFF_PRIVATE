...
function drawChart() {
    ...
    fetch('/Main/BITHUMB_BTC_OPEN_4HOUR_Ticker_Comparison?date='+date)
    ...
    .then((list) => {
        ...
        var rank1_chart = new google.visualization.LineChart(document.getElementById('bithumb_open_4hour_rank1_btc_graph'));
        rank1_chart.draw(data_btc, options_btc);

        var rank2_chart = new google.visualization.LineChart(document.getElementById('bithumb_open_4hour_rank2_btc_graph'));
        rank2_chart.draw(data_btc, options_btc);

        var rank3_chart = new google.visualization.LineChart(document.getElementById('bithumb_open_4hour_rank3_btc_graph'));
        rank3_chart.draw(data_btc, options_btc);

        var rank4_chart = new google.visualization.LineChart(document.getElementById('bithumb_open_4hour_rank4_btc_graph'));
        rank4_chart.draw(data_btc, options_btc);

        var rank5_chart = new google.visualization.LineChart(document.getElementById('bithumb_open_4hour_rank5_btc_graph'));
        ...
        for(var x=0; x<Number(main_ranking); x++){
            ...
            var chart = new google.visualization.LineChart(document.getElementById('bithumb_open_4hour_rank'+String(Number(x)+1)+'_graph'));
