...
function drawChart() {
    ...
    fetch('/Main/UPBIT_BTC_OPEN_HOUR_Ticker_Comparison?date='+date)
    ...
    .then((list) => {
        ...
        var chart = new google.visualization.LineChart(document.getElementById('upbit_open_hour_btc_graph'));
