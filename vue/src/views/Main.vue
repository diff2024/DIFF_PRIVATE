		...
		<v-row>
			<v-col xl="5" md="5" sm="5" style="text-align:center; padding-top:40px;">
				...
				<v-row>
					...
					<v-col xl="5" md="5" sm="5" style="padding-right:0px; text-align:right; font-weight:bold; font-size:20px;">
						{{ min5_gijun_datetime_kst }}
					</v-col>
				</v-row>
				<v-row>
					<v-col xl="4" md="4" sm="4" style="height: 30px; background-color: rgb(249, 250, 252); color: rgb(102, 102, 102); font-family: 돋움; font-size: 12px; font-weight:bold; padding: 0px; padding-top: 5px;">
						코인
					</v-col>
					<v-col xl="3" md="3" sm="3" style="height: 30px; background-color: rgb(249, 250, 252); color: rgb(102, 102, 102); font-family: 돋움; font-size: 12px; font-weight:bold; padding: 0px; padding-top: 5px;">
						현재가
					</v-col>
					<v-col xl="2" md="2" sm="2" style="height: 30px; background-color: rgb(249, 250, 252); color: rgb(102, 102, 102); font-family: 돋움; font-size: 12px; font-weight:bold; padding: 0px; padding-top: 5px;">
						변동률(5분)
					</v-col>
					<v-col xl="3" md="3" sm="3" style="height: 30px; background-color: rgb(249, 250, 252); color: rgb(102, 102, 102); font-family: 돋움; font-size: 12px; font-weight:bold; padding: 0px; padding-top: 5px;">
						거래대금(5분)
			...
			<v-col xl="2" md="2" sm="2" style="text-align:center; padding-top:40px;">
				...
				<img width="320px" height="240px" src="@/assets/advertise/TOP_AD.jpg" @click="Data_MIN5_Make" />
			</v-col>
			<v-col xl="5" md="5" sm="5" style="text-align:center; padding-top:40px;">
				<v-row>
					<v-col xl="12" md="12" sm="12" style="height:30px;"></v-col>
				...
				<v-row>
					<v-col xl="7" md="7" sm="7" style="padding-left:0px; text-align:left; font-size:12px;">
						거래대금은 거래량*현재가로 대략적으로 계산 되었습니다.
					</v-col>
					<v-col xl="5" md="5" sm="5" style="padding-right:25px; text-align:right; font-weight:bold; font-size:20px;">
...
export default {
	...
	methods: {
		...
		CurrentDataTime() {
			...
			if(ss == 5 || ss == 10 || ss == 20 || ss == 30 || ss == 40 || ss == 50 || ss == 59){
				this.Data_MIN5_Make();
				
				if(ss ==5 || ss == 20 || ss == 40 || ss == 59){
					this.Data_MIN15_Make();
				}
			}
		},
