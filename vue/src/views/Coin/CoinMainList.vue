				...
				<v-card-text>
					<v-row style="padding-left:15px; padding-top:0px; padding-bottom:0px;">
						...
						<v-col lg="10" md="10" sm="8" cols="8" style="padding-top:0px; padding-bottom:0px; text-align:right;">
							...
							<v-btn depressed dark small color="red" style="float:right; margin-top:17px; margin-left:10px;" :to="{ name: 'youtubeupbit_60_240'}" target="_blank">
								<v-icon small>tv</v-icon>&nbsp;<span id="btn_live_60_240" style="padding-bottom:2px;">60/240 Live</span>
							</v-btn>
							<v-btn depressed dark small color="red" style="float:right; margin-top:17px;" :to="{ name: 'youtubeupbit_5_15'}" target="_blank">
